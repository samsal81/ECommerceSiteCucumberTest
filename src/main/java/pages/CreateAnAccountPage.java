...
public class CreateAnAccountPage extends BasePage {
	...
	public void SelectDay_Selection(String day) {
		...
		SelectFromDropdownByValue(Day_Selection, day);
	}
	...
	public void SelectYear_Selection(String year) {
		SelectFromDropdownByValue(Year_Selection, year);
	}
	...
	public void VerifyErrorAlertForMandatoryFields() throws InterruptedException {
